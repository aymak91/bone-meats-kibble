...
class Messages extends React.Component {
    ...
    render() {
      ...
      // console.log(this.props.currentDog.name)
      // console.log(this.props.receivingDog.name)
      // let chatMessage =  (this.props.messages[idx].sendingDog.name === this.props.currentDog.name) ? "chat-message-left" : "chat-message-right"
                  ...
                  <div>
                    ...
                    <div className="message-body">
                      ...
                      {/* <div className="fas fa-trash"
                        id="delete-button"
                        onClick={() => this.deleteMessage(idx)}
                      /> */}
                      {/* <div
