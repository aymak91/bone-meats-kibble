...
const seed = async () => {
  ...
  const dog6 = new Dog({
    ...
    personality: "Impish",
    imageURL:
      "https://bonemeatskibble-pro.s3-us-west-1.amazonaws.com/Pomeranian.jpeg",
  });
  ...
  const dog7 = new Dog({
    ...
    personality: "Adamant",
    imageURL:
      "https://bonemeatskibble-pro.s3-us-west-1.amazonaws.com/Nymeria-S7.png",
  });
  ...
  const dog8 = new Dog({
    ...
    personality: "Relaxed",
    imageURL:
      "https://bonemeatskibble-pro.s3-us-west-1.amazonaws.com/snoop.png",
  });
  ...
  const dog9 = new Dog({
    ...
    personality: "Brave",
    imageURL:
      "https://bonemeatskibble-pro.s3-us-west-1.amazonaws.com/room8.jpg",
  });
  ...
  const dog10 = new Dog({
    ...
    personality: "Bold",
    imageURL:
      "https://bonemeatskibble-pro.s3-us-west-1.amazonaws.com/growlithe.jpg",
  });
  ...
  const dog11 = new Dog({
    ...
    personality: "Jolly",
    imageURL:
      "https://bonemeatskibble-pro.s3-us-west-1.amazonaws.com/Clifford.jpg",
  });
  ...
  const dog12 = new Dog({
    ...
    personality: "Modest",
    imageURL:
      "https://bonemeatskibble-pro.s3-us-west-1.amazonaws.com/Pomsky-Feature.jpg",
  });
  ...
  const dog13 = new Dog({
    ...
    personality: "Naughty",
    imageURL:
      "https://bonemeatskibble-pro.s3-us-west-1.amazonaws.com/Image+from+iOS.jpg",
  });
  ...
  const dog14 = new Dog({
    ...
    personality: "Relaxed",
    imageURL:
      "https://bonemeatskibble-pro.s3-us-west-1.amazonaws.com/Image+from+iOS+(1).jpg",
  });
  ...
  const dog15 = new Dog({
    ...
    personality: "Brave",
    imageURL:
      "https://bonemeatskibble-pro.s3-us-west-1.amazonaws.com/screenshot_20200904-124912_video_player.jpg",
  });
  ...
  const dog16 = new Dog({
    ...
    personality: "Impish",
    imageURL:
      "https://bonemeatskibble-pro.s3-us-west-1.amazonaws.com/How-Long-Do-Labrador-Retriever-Live-long.jpg",
  });
  ...
  const dog17 = new Dog({
    ...
    personality: "Quiet",
    imageURL:
      "https://bonemeatskibble-pro.s3-us-west-1.amazonaws.com/shih_tzu_dog_running.jpg",
  });
  ...
  const dog18 = new Dog({
    ...
    personality: "Sassy",
    imageURL:
      "https://bonemeatskibble-pro.s3-us-west-1.amazonaws.com/garfield.jpg",
  });
  ...
  const dog19 = new Dog({
    ...
    personality: "Gentle",
    imageURL:
      "https://bonemeatskibble-pro.s3-us-west-1.amazonaws.com/elke-vogelsang-1.jpg",
  });
  ...
  const dog20 = new Dog({
    ...
    personality: "Mild",
    imageURL:
      "https://bonemeatskibble-pro.s3-us-west-1.amazonaws.com/Small+White+Dog.png",
  });
  ...
  const dog21 = new Dog({
    ...
    personality: "Sassy",
    imageURL:
      "https://bonemeatskibble-pro.s3-us-west-1.amazonaws.com/shadow.jpg",
  });
  ...
  const dog22 = new Dog({
    ...
    personality: "Bold",
    imageURL:
      "https://bonemeatskibble-pro.s3-us-west-1.amazonaws.com/akamaru.jpg",
  });
  ...
  const dog23 = new Dog({
    ...
    personality: "Jolly",
    imageURL:
      "https://bonemeatskibble-pro.s3-us-west-1.amazonaws.com/kevross.jpeg",
  });
  ...
  const dog24 = new Dog({
    ...
    personality: "Naive",
    imageURL:
      "https://bonemeatskibble-pro.s3-us-west-1.amazonaws.com/Standard_Poodle_Brown.jpeg",
  });
  ...
  const dog26 = new Dog({
    ...
    personality: "Modest",
    imageURL:
      "https://bonemeatskibble-pro.s3-us-west-1.amazonaws.com/jack-russell-terrier.jpg",
  });
  ...
  const dog27 = new Dog({
    ...
    personality: "Timid",
    imageURL:
      "https://bonemeatskibble-pro.s3-us-west-1.amazonaws.com/abu+boo.png",
  });
  ...
  const dog28 = new Dog({
    ...
    personality: "Sassy",
    imageURL:
      "https://bonemeatskibble-pro.s3-us-west-1.amazonaws.com/dalmatian.jpg",
  });
  ...
  const dog30 = new Dog({
    ...
    personality: "Sassy",
    imageURL:
      "https://bonemeatskibble-pro.s3-us-west-1.amazonaws.com/corgi.jpg",
  });
